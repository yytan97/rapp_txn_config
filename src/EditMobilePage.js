...
export function EditMobilePage({ debugMode = true }) {
    const componentName = "EditMobilePage";
    ...
    function click4AddRecord(e) {
        ...
        let message = sl.m_confirm_add_mobile;
        let mobileNumber = `+${inputData.mobileCountryCode} ${inputData.mobileNumber}`;
        message = message.replace("__parameter_1", mobileNumber);
