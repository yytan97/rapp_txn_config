...
export function HotCardManagementPage({ debugMode = true }) {
    const componentName = "HotCardManagementPage";
    ...
    return (
        <div className="container-fluid px-0 bg-unity-1">
                                                                            ...
                                                                            check4Right(accessObjectName, `${accessActionPrefix}.delete`) ? (
                                                                                <li style={{borderLeft: "none", marginLeft: "0rem"}}>
                                                                                    <button
                                                                                        ...
                                                                                        <span>{sl.l_delete_hot_card}</span>
                                                                                    </button>
                                                                                </li>
                                                                            ) : null
                                                                        }
            ...
            <ChangeStatusModal
                ...
                tableName = "kswitchhotcard_list"
                databaseName = "kdb"
                accessObjectName = "webapp_configuration_access"
                accessActionPrefix = "hotcard_management"
            />
        </div>
    );
