                                        ...
                                        <div style={{ width: "100%" }} >
                                            <div className="d-flex justify-content-between">
                                                <div style={{ color: "#494D4F", fontSize: "14px" }} >
                                                    {sl.l_last_updated}: {moment(cryptogramRecord?.recordDate).format("DD MMM YYYY HH:mm:ss")}
                                                </div>
                                    ...
                                    <ClosablePanel name="cryptogram_information"
                                        ...
                                        <div className="d-flex flex-column align-items-center justify-content-center border-top"
                                            ...
                                            <div className="px-5 py-1 w-100">
                                                ...
                                                <DisplayLine label={sl.l_row_id} value={cryptogramRecord?.rowId} />
                                                <DisplayLine label={sl.l_owner_id} value={cryptogramRecord?.ownerId} />
                                                <DisplayLine label={sl.l_key_function} value={cryptogramRecord?.keyFunction} />
                                                <DisplayLine label={sl.l_key_algo} value={cryptogramRecord?.keyAlgo} />
                                                <DisplayLine label={sl.l_bit_size} value={cryptogramRecord?.bitSize} />
                                                <DisplayLine label={sl.l_iv} value={cryptogramRecord?.iv} />
                                                <DisplayLine label={sl.l_cryptogram} value={cryptogramRecord?.cryptogram} />
                                                <DisplayLine label={sl.l_kcv} value={cryptogramRecord?.kcv} />
                                            ...
                                            check4Right(accessObjectName, `${accessActionPrefix}.add`) ? (
                                                <div className="d-flex justify-content-end align-items-center px-4 border-top"
                                                    ...
                                                    <button className="btn btn-ghost-unity d-flex align-items-center"
                                                        ...
                                                        onClick={(e) => click4EditRecord(e, cryptogramRecord)}>
