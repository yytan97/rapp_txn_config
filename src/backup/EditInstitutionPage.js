...
export function EditInstitutionPage({ debugMode = true }) {
                ...
                <div className="col-8" style={{ minHeight: "50vh" }}>
                    ...
                    <div className="pb-3 border-bottom">
                        <div style={{ color: "#242627", "fontSize": "16px", fontWeight: "bold" }} >
                            {(editMode === 0) ? sl.l_add_institution : sl.l_edit_institution}
                        </div>
                    ...
                    <div className="px-4 mt-4">
                        ...
                        <div className="my-3 px-3">
                            ...
                            <div >
                                <InputLabel label={sl.l_institution_status} required />
                                <select name="institutionStatus"
                                    className={`form-select ${tBox.getClass4IsInvalid2('institutionStatus', formObject)}`}
                                    value={inputData?.institutionStatus || ""}
                                    onChange={change4Input}
                                    required>
                                    <option value="0">{getLabel(sl, "0", "o_status_")}</option>
                                    <option value="1">{getLabel(sl, "1", "o_status_")}</option>
                                    <option value="2">{getLabel(sl, "2", "o_status_")}</option>
                                    <option value="3">{getLabel(sl, "3", "o_status_")}</option>
                                    <option value="4">{getLabel(sl, "4", "o_status_")}</option>
                                    <option value="5">{getLabel(sl, "5", "o_status_")}</option>
                                </select>

                                <ErrorLine message={tBox.getFieldErrorMessage2('institutionStatus', sl, formObject)} />
                            </div>

                            <div >
                                <InputLabel label={sl.l_institution_record_type} />
                                <input name="institutionRecordType"
                                    type="text"
                                    className={`form-control ${tBox.getClass4IsInvalid2('institutionRecordType', formObject)}`}
                                    placeholder={sl.p_institution_record_type}
                            ...
                            <div>
                                <InputLabel label={sl.l_institution_owner} />
                                <input name="institutionOwner"
                                    type="text"
                                    className={`form-control ${tBox.getClass4IsInvalid2('institutionOwner', formObject)}`}
                                    placeholder={sl.p_institution_owner}
                                    value={inputData?.institutionOwner || ""}
                                    onChange={change4Input} />

                                <ErrorLine message={tBox.getFieldErrorMessage2('institutionOwner', sl, formObject)} />
                            </div>
                            ...
                            <div>
                                ...
                                <input name="institutionTimerId"
                                    ...
                                    placeholder={sl.p_institution_timer_id}
                                    value={inputData?.institutionTimerId || ""}
                                    onFocus={focus4InstitutionTimerId}
                                    readOnly />
                            ...
                            <div>
                                <InputLabel label={sl.l_processing_flags} />
                                <div className="px-3">
                                    {
                                        [1, 2, 3, 4, 5].map((item) => {
                                            return (
                            ...
                            <div className="mt-3">
                                <InputLabel label={sl.l_shutdown_flags} />
                                <div className="px-3">
                                    {
                                        [1, 2, 3].map((item) => {
                                            return (
                            ...
                            <div className="mt-3">
                                <InputLabel label={sl.l_authorization_flags} />
                                <div className="px-3">
                                    {
                                        [1, 2, 3].map((item) => {
                                            return (
                            ...
                            <div className="">
                                <InputLabel label={sl.l_institution_saf_interleave_policy} tip={sl.t_institution_saf_interleave_policy} />
                                <div className="px-3">
                                    {
                                            ...
                                            return (
                                                <div key={index} className="form-check " >
                                                    <input className="form-check-input"
                                                        ...
                                                        onChange={change4Input} />
                                                    <label className="form-check-label" htmlFor={"institutionSafInterleavePolicy" + item}>
                                                        {tBox.getLabel(sl, item, "o_institution_saf_interleave_policy_")}
                                                    </label>
                                                </div>
                                            );
                                        })
                            ...
                            <div className="mt-3">
                                ...
                                <input name="institutionSafMaxConcurrent"
                                    ...
                                    value={inputData?.institutionSafMaxConcurrent || ""}
                                    onChange={change4Input} />
                            ...
                            <div className="">
                                ...
                                <input name="institutionSafMaxTimeout"
                                    ...
                                    value={inputData?.institutionSafMaxTimeout || ""}
                                    onChange={change4Input} />
                            ...
                            <div className="">
                                ...
                                <input name="institutionSafRetry"
                                    ...
                                    value={inputData?.institutionSafRetry || ""}
                                    onChange={change4Input} />
                            ...
                            <div className="">
                                ...
                                <input name="institutionConsecutiveTimeoutCount"
                                    ...
                                    value={inputData?.institutionConsecutiveTimeoutCount || ""}
                                    onChange={change4Input} />
                            ...
                            (editMode === 1) ? null : <>
                                <div style={{ color: "#494D4F", fontSize: "16px", fontWeight: "bold" }} >
                                    ...
                                    <span className="ms-1 material-icons text-dark"
                                        ...
                                        data-bs-toggle="popover"
                                        data-bs-trigger="hover focus"
                                        data-bs-content={sl.t_transaction_type}
                                        tabIndex="-1">
                                        info
                                    </span>
                                </div>
                                ...
                                <div className="my-3 px-3">
                                    <div>
                                        ...
                                        <InputLabel label={sl.l_processing_code} />

                                        <div className="input-group">
                                            <input name="processingCodeString"
                                                type="text"
                                                className={`form-control ${tBox.getClass4IsInvalid2('processingCodeString', formObject)}`}
                                                placeholder={sl.p_processing_code}
                                                value={inputData?.processingCodeString || ""}
                                                onChange={change4Input}
                                                pattern="^\d{2}.*"
                                                list="datalist4ProcessingCode" />

                                            <datalist id="datalist4ProcessingCode">
                                                <option value="00 Purchase"></option>
                                                <option value="01 Withdrawal"></option>
                                                <option value="03 Check Guarantee"></option>
                                                <option value="09 Cash Back"></option>
                                                <option value="17 Check Verification"></option>
                                                <option value="20 Merchandise Return"></option>
                                                <option value="21 Deposit"></option>
                                                <option value="30 Debit Inquiry"></option>
                                                <option value="31 Balance Inquiry"></option>
                                                <option value="32 Mini-Statement"></option>
                                                <option value="33 Account Inquiry"></option>
                                                <option value="37 Multiple Account Data Inquiry"></option>
                                                <option value="38 Check Cleared Inquiry"></option>
                                                <option value="40 Transfer"></option>
                                                <option value="41 Card Holder Funds Transfer - Debit"></option>
                                                <option value="42 Card Holder Funds Transfer - Credit"></option>
                                                <option value="43 Bill Payment Credit"></option>
                                                <option value="49 Change PIN"></option>
                                            </datalist>

                                            <button className="btn btn-unity" type="button" onClick={click4AddProcessingCode}
                                                title="Add processing code">
                                                <span className="material-icons-outlined fs-24-unity">add</span>
                                            </button>
                                        </div>

                                        <ErrorLine message={tBox.getFieldErrorMessage2('processingCodeString', sl, formObject)} />

                                    </div>
                                    <div className="border rounded p-3 overflow-auto" style={{ minHeight: "120px" }}>
                                        <div className="row">
                                            {
                                                inputData?.processingCodeList?.map((code, index) => {
                                                    return (
                                                        <div className="col-3" key={index}>
                                                            <div className="d-flex">
                                                                <span className="material-icons-outlined fs-24-unity text-danger"
                                                                    role="button"
                                                                    onClick={() => click4RemoveProcessingCode(code, index)}>
                                                                    close
                                                                </span>
                        ...
                        <div className="my-3 px-3">
                            ...
                            <div>
                                ...
                                <input name="institutionRoutingId"
                                    ...
                                    onFocus={focus4InstitutionRoutingId}
                                    readOnly />
                            ...
                            {
                                (editMode === 1 || inputData.institutionRoutingIdOption == undefined || inputData.institutionRoutingIdOption == '1' || inputData.institutionRoutingIdOption == '4') ?
                                    null :
                                    <div>
                                        <div className="d-flex justify-content-between align-items-center" role="button"
                                            onClick={() => {
                                                inputData.closeRoutingListFlag = !(inputData?.closeRoutingListFlag);
                                                setRedraw((v) => v + 1);
                                            }}>
                                            <div className="fw-bold">{sl.l_routing_record}</div>
                                            <div className="mx-3">
                                                {
                                                    (inputData?.closeRoutingListFlag) ?
                                                        <span>
                                        ...
                                        {
                                            (inputData.closeRoutingListFlag) ? null :
                                                <div>
                                                    {
                                                        (inputData?.routingList?.length > 0) ?
                                                            <div className="table-responsive mt-3" >
                                                                <table className="table table-hover mb-0">
                                                                    <thead>
                                                                        <tr>
                                                                            <th className="col"
                                                                                style={{ fontSize: "12px", color: "#A4A6A7", fontWeight: "600", whiteSpace: "nowrap" }}>
                                                                            </th>
                                                                            {
                                                                                routingFieldList.map((record, index) => {
                                                                                    return (
                                                                                        <th key={index}
                                                                                            className="col"
                                                                                            style={{ fontSize: "12px", color: "#A4A6A7", fontWeight: "600", whiteSpace: "nowrap" }} >
                                                                                            {getLabel(sl, record.name, "th_")}
                                                                                        </th>
                                                                                    );
                                                                                })
                                                                            }
                                                                    ...
                                                                    <tbody>
                                                                        {
                                                                            inputData?.routingList.map((record, index1) => {
                                                                                return (
                                                                                    <tr key={index1} className="border-bottom" >
                                                                                        <td className="border-bottom-0 text-nowrap"
                                                                                            style={{ fontSize: "14px", cursor: "pointer" }}
                                                                                            onClick={() => click4RemoveRoutingRecord(record, index1)} >
                                                                                            <span className="material-icons-outlined fs-24-unity">delete</span>
                                                                                        </td>
                                                                                        {
                                                                                            routingFieldList?.map((fieldRecord, index2) => {
                                                                                                return (
                                                                                                    <td key={index2} className="border-bottom-0 text-nowrap"
                                                                                                        style={{ fontSize: "14px", cursor: "pointer" }}
                                                                                                        onClick={() => click4RoutingRecord(record, index1)} >
                                                            ...
                                                            : null
                                                        // end for if data list length more than zero
                                                    }


                                                    <div className="mt-3 text-end">
                                                        <button className="btn btn-unity" type="button"
                                                            onClick={click4AddRoutingRecord}
                                                            disabled={!inputData?.institutionRoutingId}
                                                            title="Add route">
                                                            <span className="material-icons-outlined fs-24-unity">add</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            // end for if close routing list flag
                                        }

                                    </div>

                                // end for if routing id option
                            }


                        </div>  {/* end of routing info */}
