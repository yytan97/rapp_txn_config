...
export function TableListOverviewPage({ debugMode = true }) {
    const componentName = "TableListOverviewPage";
                                            ...
                                            dataList.filter((record, index) => {
                                                ...
                                                return (
                                                    <tr key={index}
                                                        ...
                                                        onClick={(e) => click4Echo(e, record, index)}  >
