...
export function CryptogramManagementPage({ debugMode = true }) {
    ...
    let [searchText, setSearchText] = react.useState(searchObject.text);
    ...
    async function loadDataList() {
        ...
        try {
            ...
            if (reset) {
                ...
                let s = buildSearchString(searchObject.text);
                                    ...
                                    <tbody>
                                        {
                                            dataList.map((record, index) => {
                                                return (
                                                    <tr key={index} className="text-nowarp" style={{ cursor: "pointer", fontSize: "14px" }} >
                                                        <td className=" "
