...
export function SystemConfigurationDashboard({ debugMode = false }) {
    ...
    const menuList = [
        { name: "institution_settings", callback: callback4CreateNewInstitution, icon: "/images/institution.svg", accessObject: "webapp_configuration_access", accessAction: "institution_management.add" },
