                            ...
                            <div className="col-11 col-xl-12">
                                ...
                                <div className="d-flex justify-content-center">
                                    <div className="col-12">
                                        {
                                            tabIndex === 1 ? (
                                                <ClosablePanel name="link_information"
                                                    title={sl.l_link_information}
                                                    closeFlag={closePanel?.link_information}
