...
import { cleanUp as cleanUp4Detail } from "./UserDetailPage.js";
...
export function UserManagementPage({ debugMode = true }) {
    const componentName = "UserManagementPage";
    ...
    */
        ...
        try {
            ...
            if (reset) {
                ...
                */
                ...
                let result2 = await apiBox.createUserCursor(getSessionToken(), searchObject.searchText);
            ...
            fixPage();
            let result4 = await apiBox.rewindNFetch4User(getSessionToken(), cursorId, pageObject.page, pageObject.pageSize);
    ...
    function click4DeleteRecord(e, record, index) {
        ...
        let message = sl.m_confirm_delete_user;
        ...
        showConfirmDialogBox(message, async () => {
            ...
            showStateDialogBox();
            try {
                let result1 = await apiBox.deleteRecord4User(getSessionToken(), record.name);

                if (result1 && result1.flag) {

                    let message = sl.m_user_deleted;
                    showInfoDialogBox(message, () => {
                        return;
                    });
