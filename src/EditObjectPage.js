...
export function EditObjectPage({ debugMode = true }) {
    const componentName = "EditObjectPage";
    ...
    function click4AddRecord(e) {
        ...
        let message = sl.m_confirm_add_object;
        message = message.replace("__parameter_1", inputData.objectName);
        showConfirmDialogBox(message, async function () {
            showStateDialogBox();
            try {

                let result1 = await apiBox.addRecord4Object(getSessionToken(), inputData.objectName);
                if (result1 && result1.flag) {
                    formObject.dirty = false;

                    let message = sl.m_object_added;
                ...
                <div className="col-8" style={{ minHeight: "50vh" }}>
                    ...
                    <div className="px-4 mt-4">
                        ...
                        <div className="my-3 px-3">
                            ...
                            <div>
                                <InputLabel label={sl.l_object_name} required />
                                <input name="objectName"
                                    type="text"
                                    className={`form-control ${tBox.getClass4IsInvalid2('objectName', formObject)}`}
                                    placeholder={sl.p_object_name}
                                ...
                                <ErrorLine message={tBox.getFieldErrorMessage2('objectName', sl, formObject)} />
                            </div>
