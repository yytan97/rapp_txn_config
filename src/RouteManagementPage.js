...
const accessActionPrefix = "route_management";
...
export function RouteManagementPage({ debugMode = true }) {
    const componentName = "RouteManagementPage";
                ...
                <div className="flex-fill" style={{ ...(dataset?.mainPanelWidth) }}>
                    <div className="pl-24 pr-24" style={{ minHeight: "100vh", }}>
                        ...
                        <div className="col-12 d-flex">
                            <Card label={sl.l_route_management_last_updated} tip={sl.t_insti_last} numCount="150"/>
                            <Card label={sl.l_active_route_management} tip={sl.t_insti_last} numCount={activeRecord}/>
                            <Card label={sl.l_total_route_management} tip={sl.t_insti_last} numCount={totalRecord}/>
                        </div>
