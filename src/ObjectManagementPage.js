...
import { cleanUp as cleanUp4Detail } from "./ObjectDetailPage.js";
...
export function ObjectManagementPage({ debugMode = true }) {
    const componentName = "ObjectManagementPage";
    ...
    */
        ...
        try {
            ...
            if (reset) {
                ...
                */
                ...
                let result2 = await apiBox.createObjectCursor(getSessionToken(), searchObject.searchText);
            ...
            fixPage();
            let result4 = await apiBox.rewindNFetch4Object(getSessionToken(), cursorId, pageObject.page, pageObject.pageSize);

            if (result4.flag) {
                let list1 = result4.data.accessRightsObjects;
                /* preprocess 
    ...
    function click4DeleteRecord(e, record, index) {
        ...
        let message = sl.m_confirm_delete_object;
        ...
        showConfirmDialogBox(message, async () => {
            ...
            showStateDialogBox();
            try {
                let result1 = await apiBox.deleteRecord4Object(getSessionToken(), record.name);

                if (result1 && result1.flag) {

                    let message = sl.m_object_deleted;
                    showInfoDialogBox(message, () => {
                        return;
                    });
